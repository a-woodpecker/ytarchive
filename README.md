...
(`ytarchive_0.3.0~bookworm_amd64.deb`) as a record of where it was built.
...
| Running on | Offered |
|---|---|
| Windows x86_64 | `YTArchive-0.3.0-setup.exe` |
| Debian 12 amd64 | `ytarchive_0.3.0~bookworm_amd64.deb` |
| Ubuntu 24.04 amd64 | `ytarchive_0.3.0~noble_amd64.deb` |
| Debian arm64 | `ytarchive_0.3.0~bookworm_arm64.deb` |
